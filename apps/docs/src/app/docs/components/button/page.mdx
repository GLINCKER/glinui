...
import { getRegistryItem } from "@glinr/registry"
...
>
  ...
  <InstallTabs command={item?.install.package ?? "npm install @glinr/ui @glinr/tokens"} />

  ### Registry

  <InstallTabs command={item?.install.registry ?? "pnpm dlx @glinr/cli@latest add button"} />
  ...
  <ExampleBlock
    codeDefaultOpen
    code={`import { Button } from "@glinr/ui"
  ...
  <PropsTable
    rows={[
      ...
      },
      {
        ...
        type: `"sm" | "md" | "lg"`,
        defaultValue: "md",
        description: "Height and horizontal padding scale."
      },
      {
        prop: "asChild",
        type: "boolean",
        defaultValue: "false",
        description: "Renders child element with button styles."
      }
    ]}
  />
